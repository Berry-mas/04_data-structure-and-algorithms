...
* DFS는 한 방향으로 깊에 들어간 후, 막다른 길에 도달하면 다시 되돌아오므로
...
import static com.ohgiraffers.section02.searching.B_BFS.bfs;
...
public class C_ShortestPath {
    ...
    static void bfs(int x, int y) {
        ...
        /* 시작 지점에서부터 큐를 이용해서 큐에 담기는 노드가 제거될 때까지
         * 너비 우선 탐색을 진행한다. */
        while (!q.isEmpty()) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                /* 좌표가 전체 범위를 넘어갔다면 확인이 불필요하므로 다음 방향 확인 */
